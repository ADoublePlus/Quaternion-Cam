/*
    Following sites used for guidance:
        For efficient forms of all algorithms used:
...
{
    /*
        Using the above formula for vectors and angles
...
/*
    Based on the Following code sourced from:
    http://www.gpwiki.org/index.php/OpenGL:Tutorials:Using_Quaternions_to_represent_rotation
